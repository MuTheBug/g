...
class ScannerScreen extends ConsumerStatefulWidget {
  const ScannerScreen({
    ...
    required this.onSymbolSweepTap,
    required this.onEquityTap,
  });
  ...
  final VoidCallback onSymbolSweepTap;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            tooltip: 'Symbol sweep',
            onPressed: widget.onSymbolSweepTap,
